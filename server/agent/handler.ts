import type { AgentMessage, AnyRecord, ChatOptions } from '../../shared/types.ts';
import { tools } from './tools.ts';
import { runTools } from './runner.ts';
import { callLlmStream } from '../llm/stream.ts';
import { normalizeAgentMessages, normalizeChatOptions } from './utils.ts';

export const chat = async (messages: AgentMessage[], {
  provider,
  apiUrl,
  apiKey,
  model,
  send = (_message: AnyRecord) => {},
  signal,
  maxRounds = 50,
