...
<template>
  <div class="chat-scroll-bubble max-w-[min(78%,720px)] rounded-md rounded-tl-[2px] border border-line bg-bg-elev px-3.5 py-2.5 text-[14px] leading-[1.6] max-md:max-w-[92%]" style="width: fit-content;">
