<template>
  <div class="flex h-full flex-col bg-[#f5f0e8] font-['Georgia','PingFang_SC',serif] dark:bg-[#1a1410]">
    ...
    <div class="flex flex-1 overflow-hidden">
      <!-- 左侧：转盘 + 输入 -->
      <div class="flex w-[400px] flex-shrink-0 flex-col items-center justify-center gap-6 border-r border-[#dcd0b8] p-8 dark:border-[#2a1e14]">
        <!-- 转盘 -->
        <div class="relative">
          <svg width="260" height="260" viewBox="0 0 260 260" class="drop-shadow-lg">
      ...
      <div class="flex flex-1 flex-col overflow-hidden">
        <!-- 当前结果 -->
        <div v-if="result" class="border-b border-[#dcd0b8] p-6 dark:border-[#2a1e14]">
          <div class="mx-auto max-w-[480px] rounded-xl border border-[#dcd0b8] bg-[#fffdf8] p-6 text-center shadow-sm dark:border-[#3a2a1a] dark:bg-[#221a12]">
        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          <div v-else class="flex h-full items-center justify-center text-sm text-[#b8a888] dark:text-[#4a3a28]">
            尚无卦象记录
          </div>
        </div>
      </div>
