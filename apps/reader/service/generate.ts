...
import { findSessionById, countChapters, insertChapter, updateSessionProgress } from '../repository/generate.ts';
...
export const generate = async ({ sessionId, action, prompt, locale, taskTitle, req }) => {
