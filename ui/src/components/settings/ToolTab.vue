  ...
  <section class="space-y-3">
    <div class="rounded-xl border border-[#dcd0b8] bg-[#fffdf8] p-4 dark:border-[#2a1e14] dark:bg-[rgba(30,22,14,0.4)]">
      ...
      <div class="mt-3 flex items-center gap-3">
        <span class="text-xs text-[#a0907a] dark:text-[#6a5840]">工具结果内容长度</span>
        <input
      ...
      <div class="mt-1.5 text-[11px] text-[#c0b098] dark:text-[#5a4a30]">默认 12000，范围 1000 - 50000</div>
    </div>
    ...
    <div class="rounded-xl border border-[#dcd0b8] bg-[#fffdf8] p-4 dark:border-[#2a1e14] dark:bg-[rgba(30,22,14,0.4)]">
      ...
      <div class="mt-3 flex items-center gap-3">
        <span class="text-xs text-[#a0907a] dark:text-[#6a5840]">工具最大循环次数</span>
        <input
          :value="toolMaxRounds"
      ...
      <div class="mt-1.5 text-[11px] text-[#c0b098] dark:text-[#5a4a30]">默认 50，范围 1 - 500</div>
    </div>
