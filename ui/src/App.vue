<template>
  <div class="h-screen w-screen overflow-hidden flex flex-col bg-white text-neutral-800 dark:bg-neutral-900 dark:text-neutral-200" style="height: 100dvh;">
    ...
    <!-- 顶部栏：固定，全宽 -->
    <div class="relative z-[80] flex h-11 shrink-0 items-center gap-3 border-b border-gray-200 bg-white px-3 dark:border-neutral-800 dark:bg-neutral-900">
    ...
    <div class="flex flex-1 min-h-0 relative">
      ...
      <div v-show="sidebarOpen"
        class="relative z-[70] h-full w-[220px] shrink-0 border-r border-gray-200 bg-gray-50 dark:border-neutral-800 dark:bg-neutral-900 max-md:absolute max-md:inset-y-0 max-md:left-0 max-md:shadow-xl">
