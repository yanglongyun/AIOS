<template>
  ...
  >
    <input
      ref="searchEl"
      v-model="search"
      class="mb-2.5 w-full rounded-[8px] border border-[rgba(200,160,96,0.3)] bg-[rgba(245,240,232,0.9)] px-3 py-1.5 text-[13px] text-[#3a2a18] outline-none placeholder-[#b0a090] focus:border-[#c8a060]"
