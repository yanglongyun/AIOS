...
import { getMessageById, updateReplySuggestion } from '../repository/suggest.js';

export const generateSuggestion = async (body = {}, req) => {
...
- 必须输出 JSON：{"suggestion":"..."}`
    ...
    updateReplySuggestion(suggestion, id);
