...
export const initReaderDatabase = () => {
  ...
  if (count === 0) {
    ...
    const s2 = insertSession.run(
      'The Last Station Librarian', 'A lone librarian guards the final archive at the edge of a frozen world',
      ...
      'Chapter 1', 1, '2026-02-12 09:00:00', '2026-02-12 09:30:00'
    );
    insertChapter.run(s2.lastInsertRowid, 1, 'Open the station',
      ...
      'Mira opens the Last Station Library and meets a traveler searching for a map of the old rail.', 'Chapter 1', '2026-02-12 09:30:00'
    );
  }
};
