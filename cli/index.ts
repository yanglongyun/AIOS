...
import { ROOT, WEB_URL, API_URL, APPS_URL, SERVER_PORT, APPS_PORT } from './config.ts';
import { getServiceStatus, startServices, stopServices, buildUI, isReady, waitReadyUrl } from './service.ts';
import { startChat } from './chat.ts';
import { runUninstall } from './uninstall.ts';
import t from './locale.ts';
import { banner, createSpinner } from './ui.ts';
