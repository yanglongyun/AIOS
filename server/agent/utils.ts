import type { AgentMessage, AnyRecord } from '../../shared/types.ts';

export const truncateToolResult = (content: unknown, { enabled = true, maxChars = 12000 }: { enabled?: boolean; maxChars?: number } = {}) => {
...
const parseBoundedInt = (name: string, value: unknown, min: number, max: number) => {
...
export const normalizeChatOptions = (options: AnyRecord = {}) => {
  return {
...
export const normalizeAgentMessages = (messages: AnyRecord[] = []): AgentMessage[] => {
