const zh = {
  ...
  helpUpdate: '更新代码并重启（git pull + npm ci）',
  helpStatus: '查看服务状态',
  helpWeb: '浏览器打开 AIOS',
  ...
  pullingCode: '拉取最新代码...',
  pullDone: '代码已更新',
  pullFailed: '更新失败: git pull 执行失败',
  installingDeps: '安装依赖...',
  depsDone: '依赖安装完成',
  depsFailed: '更新失败: npm ci 执行失败',
  updateDone: 'AIOS 更新完成并已重启',
...
const en = {
  ...
  helpUpdate: 'Update code and restart (git pull + npm ci)',
  ...
  pullingCode: 'Pulling latest code...',
  pullDone: 'Code updated',
  pullFailed: 'Update failed: git pull failed',
  installingDeps: 'Installing dependencies...',
  depsDone: 'Dependencies installed',
  depsFailed: 'Update failed: npm ci failed',
  updateDone: 'AIOS updated and restarted',
